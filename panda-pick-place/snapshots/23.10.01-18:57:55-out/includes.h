...
const int STRUCT_CHANGE_FREQ = 2;       // Only enumerate over new program structures after this many iterations, else tune parameters for previous best structure
...
const double TEMP_CHANGE = 0.1;           // TEMPERATURE decreases linearly by this much each iteration. Encourages exploration in earlier iterations, then convergence in later iterations.
