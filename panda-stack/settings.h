...
namespace SETTINGS {
    ...
    const int VALIDATION_SET = 15;              // Number of total robots in the full set (including the training set)
    ...
    const double PROG_COMPLEXITY_LOSS = 0.01;          // adds L1 loss ( AST.size * PROG_COMPLEXITY_LOSS * loss )
