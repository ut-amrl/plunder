...
<br>Stop Sign (SS): acceleration control in a straight line.
<br>Pass Traffic (PT): switching lanes in highway traffic.
<br>Merge (MG): merging from the leftmost to the rightmost lane in highway traffic.
<br>Pick and Place (PP): controlling a robot arm to grab and object and move it to a designated location.
<br>Stack (ST): stacking two boxes on top of each other at a designated location.
</p>
<img src="assets/stack.gif" style="width: 500px"/>
</div>
