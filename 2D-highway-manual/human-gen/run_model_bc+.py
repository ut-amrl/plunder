...
sim_time = 150
samples = 50
folder = "../../baselines/supervised_learning_ha/highway_manual/"
vars_used = [
    "HA",
    "x",
    "y",
...
model = keras.models.load_model(folder + "model_manual_pt", compile=False)
...
env.config['policy_frequency']=6 # Runs once every 3 simulation steps
