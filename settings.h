...
const double stddevError = 0.0;     // low-level action error standard deviation
...
const double activationMinAcc = 0.05;    // Minimum acceleration (acceleration will not go below this value, excluding 0)
